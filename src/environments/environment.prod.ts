...
export const environment: KeystoneEnvironment = {
  production: true,
  name: 'prod',
  issuer: 'https://login.northgatetrust.example/keystone',
  clientId: 'keystone-web',
  redirectUri: 'https://login.northgatetrust.example/callback',
  postLogoutRedirectUri: 'https://login.northgatetrust.example/',
  bffBaseUrl: 'https://api.northgatetrust.example/retail',
  requireHttps: true,
