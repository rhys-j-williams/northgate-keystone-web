...
Owner: @northgate/identity-platform. Standard reference: GIS-STD-014 Application Security Requirements for Internet
...
(`gis-appsec-intake@northgate.internal`) with the component name `keystone-web` and, if the finding came
